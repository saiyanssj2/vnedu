// Kho nhận xét lớp 5 — môn học tương tự lớp 4, nội dung nâng cao hơn
const KHO_LOP5 = {
  'Tiếng Việt_xuat_sac': [
    'Đọc diễn cảm, phân tích sâu nội dung bài đọc, viết bài văn mạch lạc, sáng tạo và giàu cảm xúc.',
    'Có vốn từ phong phú, viết bài văn có bố cục chặt chẽ, dùng từ ngữ chính xác và hình ảnh sinh động.',
    'Nắm vững kiến thức Tiếng Việt lớp 5, đọc hiểu tốt và viết bài văn thể hiện cảm xúc chân thực.',
    'Đọc diễn cảm và hiểu sâu ý nghĩa bài đọc, viết bài văn sáng tạo và trình bày sạch đẹp.',
    'Học tốt môn Tiếng Việt, biết phân tích nhân vật và viết bài văn miêu tả, kể chuyện sinh động.',
    'Tiếp thu nhanh, đọc trôi chảy và viết bài văn có ý tưởng sáng tạo, diễn đạt mạch lạc, rõ ý.',
  ],
  'Tiếng Việt_tot': [
    ...
    'Biết đọc hiểu bài và viết bài văn đúng yêu cầu, trình bày bài gọn gàng, sạch đẹp.',
  ],
  ...
  'Toán_xuat_sac': [
    'Thực hiện thành thạo các phép tính với số thập phân, phân số, giải toán nhanh và chính xác.',
    'Nắm vững kiến thức Toán lớp 5, tính toán đúng và biết vận dụng vào giải toán thực tế.',
    'Tư duy toán học tốt, làm bài chính xác và biết giải các bài toán liên quan đến tỉ số, diện tích.',
    'Hiểu sâu các dạng toán, giải bài nhanh và đúng, có khả năng tư duy logic xuất sắc.',
    'Nắm chắc kiến thức về số thập phân và phân số, giải toán có lời văn rõ ràng và khoa học.',
  ...
  'Khoa học_xuat_sac': [
    ...
    'Có tư duy khoa học tốt, biết quan sát, thí nghiệm và rút ra kết luận chính xác, khoa học.',
...
if (typeof module !== 'undefined') module.exports = KHO_LOP5;
